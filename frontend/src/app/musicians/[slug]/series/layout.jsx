...
export const generateMetadata = async ({ params }) => {
    ...
    return buildMetadata({
        title: `Series Scored by ${musician.fullName}`,
        description: `Every series on StreamVibe scored by ${musician.fullName}, with trailers, ratings and reviews.`,
        path: `/musicians/${params.slug}/series`,
    });
};
