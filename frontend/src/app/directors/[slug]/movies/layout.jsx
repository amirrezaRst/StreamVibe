...
export const generateMetadata = async ({ params }) => {
    ...
    return buildMetadata({
        title: `Films Directed by ${director.fullName}`,
        description: `Every film on StreamVibe directed by ${director.fullName}, with trailers, ratings and reviews.`,
        path: `/directors/${params.slug}/movies`,
    });
};
